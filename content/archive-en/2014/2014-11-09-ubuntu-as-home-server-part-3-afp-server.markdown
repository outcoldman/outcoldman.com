...
slug: "ubuntu-as-home-server-part-3-afp-server"
---
...
**NOTE: I highly recommend to take a look on how to install `netatalk` with `Docker` in this article [Using docker at home](/en/archive/2015/03/18/docker-for-home-server/)**
